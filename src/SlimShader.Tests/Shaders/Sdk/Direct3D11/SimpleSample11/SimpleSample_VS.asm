...
//   float4 g_MaterialAmbientColor;     // Offset:  128 Size:    16
//   float4 g_MaterialDiffuseColor;     // Offset:  144 Size:    16
//
// }
//
// cbuffer cbPerFrame
...
//   float g_fTime;                     // Offset:   12 Size:     4 [unused]
...
mul r0.yzw, cb0[9].xxyz, cb1[1].xxyz
mad o1.xyz, r0.yzwy, r0.xxxx, cb0[8].xyzx
mov o1.w, l(1.000000)
mov o2.xy, v2.xyxx
ret 
