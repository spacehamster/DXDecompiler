#define RS1 "RootFlags( ALLOW_INPUT_ASSEMBLER_INPUT_LAYOUT | DENY_VERTEX_SHADER_ROOT_ACCESS " \
              ...
              "SRV(t59, space=2748, visibility=SHADER_VISIBILITY_HULL, flags=DATA_STATIC_WHILE_SET_AT_EXECUTE), " \
              "UAV(u57, space=2748, visibility=SHADER_VISIBILITY_DOMAIN, flags=DATA_STATIC), " \
