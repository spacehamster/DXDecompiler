...
add r0.x, r0.y, r0.x
ld_structured r1.xyzw, v0.x, l(0), t111.xyzw
add r0.x, r0.x, r1.x
utof r0.y, r1.y
add r0.x, r0.y, r0.x
add r0.x, r1.z, r0.x
add r0.x, r1.w, r0.x
ld_structured r1.x, v0.x, l(16), t111.xxxx
add r0.x, r0.x, r1.x
ld_structured r1.x, v0.x, l(112), t111.xxxx
add r0.x, r0.x, r1.x
ld_structured r1.x, v0.x, l(200), t111.xxxx
add r0.x, r0.x, r1.x
ld_structured r1.xy, v0.x, l(232), t111.xyxx
itof r0.y, r1.x
add r0.x, r0.y, r0.x
add r0.x, r1.y, r0.x
ld_structured r1.xy, v0.x, l(260), t111.xyxx
itof r0.y, r1.x
add r0.x, r0.y, r0.x
add r0.x, r1.y, r0.x
ld_structured r1.xy, v0.x, l(324), t111.xyxx
add r0.x, r0.x, r1.x
add r0.x, r1.y, r0.x
ld_structured r1.xy, v0.x, l(440), t111.xyxx
add r0.x, r0.x, r1.x
add r0.x, r1.y, r0.x
