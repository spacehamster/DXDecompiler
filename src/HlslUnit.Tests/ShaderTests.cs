	...
	public class ShaderTests
	{
		...
		public void CanExecuteVertexShader()
		{
            ...
            var shader = new Shader(ShaderTestUtility.CompileShader(
				$"{TestContext.CurrentContext.TestDirectory}/Shaders/VS/BasicHLSL.fx", "RenderSceneVS", "vs_4_0"));
        ...
        public void CanExecutePixelShader()
        {
            // Arrange.
            var shader = new Shader(ShaderTestUtility.CompileShader(
                $"{TestContext.CurrentContext.TestDirectory}/Shaders/VS/BasicHLSL.fx", "RenderScenePS", "ps_4_0",
