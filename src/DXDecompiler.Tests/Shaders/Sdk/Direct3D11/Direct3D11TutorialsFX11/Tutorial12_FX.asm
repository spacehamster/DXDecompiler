    ...
    technique11 Render
    {
        pass P0
        {
            VertexShader = asm {
                ...
                mad o3.xyz, r1.zzzz, l(0.000000, 0.000000, -2.000000, 0.000000), r1.xyzx
                ret 
            ...
            PixelShader = asm {
                ...
                // samLinearClamp                    sampler      NA          NA             s1      1 
                ...
                sample r1.xyzw, v3.xyzx, t1.xyzw, s1
                sample r2.xyzw, v2.xyxx, t0.xyzw, s0
                mad o0.xyz, r2.xyzx, r0.xxxx, r1.xyzx
                mov o0.w, l(1.000000)
                ret 
