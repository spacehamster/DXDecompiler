...
// g_float2Buffer                    texture  float2         buf             t1      1 
// g_adjBuffer                       texture  float3         buf             t2      1 
// g_triCenterBuffer                 texture  float4         buf             t3      1 
...
if_nz r0.x
  ...
  if_nz r0.x
    ...
    ld r1.xyzw, r0.xxxx, t3.xyzw
    iadd r0.x, r0.x, l(1)
    ld r0.xyzw, r0.xxxx, t3.xyzw
    utof r0.w, v[0][5].x
  ...
  if_nz r0.x
    ...
    if_nz r0.x
      ...
      ld r1.xyzw, r0.yyyy, t2.xyzw
      ld r2.xyzw, r0.zzzz, t2.xyzw
      add r0.y, r0.x, r0.x
      ftoi r0.y, r0.y
      ld r3.xyzw, r0.yyyy, t3.xyzw
      mad r0.y, r0.x, l(2.000000), l(1.000000)
      ftoi r0.y, r0.y
      ld r4.xyzw, r0.yyyy, t3.xyzw
      add r0.yzw, r3.xxyz, -v[0][4].xxyz
      add r1.y, r1.x, r1.x
      ftoi r1.y, r1.y
      ld r5.xyzw, r1.yyyy, t3.xyzw
      mad r1.y, r1.x, l(2.000000), l(1.000000)
      ftoi r1.y, r1.y
      ld r6.xyzw, r1.yyyy, t3.xyzw
      add r1.yzw, r5.xxyz, -v[0][4].xxyz
      add r2.y, r2.x, r2.x
      ftoi r2.y, r2.y
      ld r7.xyzw, r2.yyyy, t3.xyzw
      mad r2.y, r2.x, l(2.000000), l(1.000000)
      ftoi r2.y, r2.y
      ld r8.xyzw, r2.yyyy, t3.xyzw
      ...
      rsq r4.w, r4.w
      ld r10.xyzw, l(0, 0, 0, 0), t1.xyzw
      mad r4.w, r9.x, r4.w, r10.x
